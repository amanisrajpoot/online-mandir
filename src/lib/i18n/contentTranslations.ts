export const TEMPLE_TRANSLATIONS: Record<string, any> = {
  ...
  'Baglamukhi Mandir, Nalkheda': {
    hi: {
      name: "माँ बगलामुखी मंदिर, नलखेड़ा",
      location: "नलखेड़ा, आगर मालवा (उज्जैन के पास), मध्य प्रदेश",
      description: "लखुंदर नदी के तट पर स्थित यह प्राचीन शक्तिपीठ शत्रु बाधा, कोर्ट केस निवारण और तंत्र रक्षा के लिए प्रसिद्ध है।"
    },
    mr: {
      name: "माँ बगलामुखी मंदिर, नलखेडा",
      location: "नलखेडा, आगर माळवा (उज्जैन जवळ), मध्य प्रदेश",
      description: "लखुंदर नदीच्या काठावर वसलेले हे प्राचीन शक्तीपीठ शत्रू पीडा, कोर्ट कचेरी निवारण आणि तंत्र संरक्षणासाठी प्रसिद्ध आहे."
    },
    gu: {
      name: "મા બગલામુખી મંદિર, નલખેડા",
      location: "નલખેડા, અગર માલવા (ઉજ્જૈન પાસે), મધ્ય પ્રદેશ",
      description: "લખુંદર નદીના કાંઠે આવેલું આ પ્રાચીન શક્તિપીઠ શત્રુ વિજય અને કોર્ટ કેસના નિવારણ માટે પ્રખ્યાત છે."
    }
  }
};

export const PUJA_TRANSLATIONS: Record<string, any> = {
  'Baglamukhi Mirchi Havan': {
    hi: {
      title: "माँ बगलामुखी लाल मिर्च हवन एवं शत्रु विजय पूजा",
      problem_statement: "कोर्ट केस, शत्रु भय, कानूनी विवाद, काली नजर या व्यापारिक रुकावटों से परेशान हैं?",
    },
    mr: {
      title: "माँ बगलामुखी लाल मिरची हवन व शत्रू विजय पूजा",
      problem_statement: "कोर्ट केस, शत्रू भय, कायदेशीर वाद, दृष्ट किंवा व्यवसायातील अडचणींनी त्रस्त आहात का?",
    },
    gu: {
      title: "મા બગલામુખી લાલ મરચાં હવન અને શત્રુ વિજય પૂજા",
      problem_statement: "કોર્ટ કેસ, શત્રુ ભય, કાનૂની વિવાદ, નજર દોષ કે વેપારમાં મુશ્કેલીઓ છે?",
    }
  },
  'Suktam Havan': {
    hi: {
